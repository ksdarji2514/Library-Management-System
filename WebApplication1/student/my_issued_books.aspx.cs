        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr1 in dt1.Rows)
            {
              ...
              //  dr["lateday"] = dr1["lateday"].ToString();
                ...
                // dr["penalty"] = Convert.ToString(Convert.ToDouble(noofdays)*Convert.ToString(penalty));
                dr["penalty"] = Convert.ToDouble(Convert.ToDouble(noofdays) * Convert.ToDouble(penalty));
                dt.Rows.Add(dr);
            }
            d1.DataSource = dt;
            d1.DataBind();
